...
const educationData = [
  ...
  },
  {
    ...
    institution: 'WPA Soundrapandian Higher Secondary School, Ayanavaram, Chennai',
    period: '2021 – 2023',
    grade: '85%',
    gradeLabel: 'Score',
    ...
    color: 'var(--secondary)',
    icon: '📚',
    highlights: ['Science Stream', '85% Score', 'Mathematics Focus'],
  },
  {
    degree: 'Secondary School Leaving Certificate (SSLC)',
    institution: 'BMHSS Ayanavaram , Chennai',
    period: '2020 – 2021',
    grade: '85%',
    gradeLabel: 'Score',
